...
class tenantLis():
    ...
    def checkCaseStatus(self,case_Id,case_Status,to_csv1):
        try:
            ...
            self.driver.refresh()           
    def tenantLisSearch(self,caseDetails,tenant,fileName,today_Date,lispendens):
        try:
            to_csv1=[]
...
obj=tenantLis()
obj.tenantLisSearch(caseDetails,tenant,fileName,today_Date,lispendens)





'''sean@ozellrealestate.com,
RealEstate45!
'''
