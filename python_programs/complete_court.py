...
for i in data:
    ...
    if (table2=='OPEN'):
        ...
        table_value=(table,table1,table2,table3,table4,table5)
        print(table_value)
        file=open("D:\AK\Pdf_to_text\dual_court\Data_files.txt",'a')
        print(file.write("{}\n".format(table_value)))
read_file = pd.read_csv ('D:\AK\Pdf_to_text\dual_court\Data_files.txt')
read_file.to_csv ('D:\AK\Pdf_to_text\dual_court\Data_files.csv', index=None)       
